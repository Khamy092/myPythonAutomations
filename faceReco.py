...
face_names = {
    "face_7.jpg": "James Maddison",
}
# Load the cascade classifier
face_cascade = cv2.CascadeClassifier("facemodel.xml")

# Load the reference face
reference_face = cv2.imread("face_7.jpg", cv2.IMREAD_GRAYSCALE) # face_7.jpg is the reference face
...
for (x, y, w, h) in faces:
    ...
    if max_value > 0.9:
        ...
        if "face_7.jpg" in face_names:
            cv2.putText(img, face_names["face_7.jpg"], (x, y - 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
